...
class MessageCell: UITableViewCell, SKPhotoBrowserDelegate, UIContextMenuInteractionDelegate {
    ...
    func configure(post: ChatBskyLexicon.Conversation.MessageViewDefinition) {
        ...
        self.contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-18-[avatar(44)]-12-[username]-8-[time]-(>=18)-|", options: [], metrics: nil, views: viewsDict))
