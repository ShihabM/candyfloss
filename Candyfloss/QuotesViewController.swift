...
class QuotesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchResultsUpdating, UISearchBarDelegate {
        ...
        Task {
            do {
                if let atProto = GlobalStruct.atProto {
                    let x = try await atProto.getQuotes(from: postURI, postCID: postCID, cursor: currentCursor)
                    allPosts += x.posts
    ...
    func setUpTable() {
        ...
        self.searchController = ({
            ...
            controller.searchBar.placeholder = "Search Quotes"
